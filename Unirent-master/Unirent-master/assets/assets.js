...
export const categories = ["Laptops", "Books", "Furniture", "Calculators", "Appliances", "Sports"];
...
export const dummyStoreData = {
    ...
    userId: "user_1",
    name: "UniRent Store",
    description: "At UniRent, we believe that university life should be affordable and sustainable. Whether you're looking for textbooks, high-end laptops, temporary furniture, or lab equipment — we've got everything students need to succeed, available for rent.",
    username: "happyshop",
